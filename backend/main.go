...
func main() {
	...
	r.HandleFunc("/v1/aftermarket/domains/watches", appH.GetWatchlistListings).Methods("GET")
	...
	r.HandleFunc("/admin/listings/{id}/radar", adminH.UpdateRadarVisible).Methods("PUT")
