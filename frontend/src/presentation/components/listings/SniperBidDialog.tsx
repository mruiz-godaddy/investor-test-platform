    ...
    <Dialog open={open} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <DialogPanel className="w-full max-w-sm rounded-xl bg-white dark:bg-gray-900 p-6 shadow-xl">
          <DialogTitle className="text-lg font-semibold text-gray-900 dark:text-white">Sniper Bid</DialogTitle>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{listing.domainName}</p>
          <p className="mt-1 text-xs text-gray-400 dark:text-gray-500">Suggested: ${suggestedBid.toFixed(2)}</p>
          <div className="mt-4 space-y-3">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200">Shopper</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200">Bid Amount ($)</label>
