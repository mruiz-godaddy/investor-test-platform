...
export default function ScenariosPage() {
  ...
  return (
    <div>
      <h2 className="text-xl font-bold text-gray-900">Scenarios</h2>
      <p className="mt-1 text-sm text-gray-500">Load a predefined scenario. This resets the database first.</p>
      <div className="mt-4">
